---
name: tta-tone
description: 为 oil 本人的中文或英文成稿提供文风规范。适用于博客、演讲稿、PPT 文案、网站与产品介绍、个人简介、公众号、社交帖子，以及用户明确要求“使用 tta-tone”“用我的语气写”或要求文字代表本人时。要求在事实边界内平铺直叙，语法结构完整、易读并且朗读通顺；面向读者时根据情况使用「我们」或「大家」，尽量不用含义含糊或可以自然替换的单字动作词，避免虚构内容、无意义冗余、模板化表达和拔高立意。
---
